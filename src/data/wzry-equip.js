export default {
  "穿云弓": {
    ...
    "tier": "2",
    "info": {
      "icon": "https://img.18183.com/uploads/allimg/180820/237-1PR0154330143.jpg",
      "price": "1100",
      "detail": "",
      "parent_id": "破晓",
      "child_id": "匕首,雷鸣刃",
  ...
  "破晓": {
    ...
    "info": {
      ...
      "effect": [{
        "name": "破甲",
        "effect": "+22.5%物理穿透（远程英雄使用时效果翻倍）",
        "type": "unique_passive"
      }, {
        "name": "攻击加成",
        "effect": "普通攻击伤害提升50点（远程英雄使用时效果翻倍）",
        "type": "unique_passive"
      }],
      "suit": ""
    }
  ...
  "贤者的庇护": {
    ...
    "info": {
      ...
      "effect": [{
        "name": "复生",
        "effect": "复雄等级*100点生命值，这个效果有3分钟CD，每局复活两次。",
        "type": "unique_passive"
      }],
      "suit": ""
    }
  ...
  "不死鸟之眼": {
    ...
    "info": {
      ...
      "effect": [{
        "name": "血统",
        "effect": "每损失10%的血量，提升治疗效果6%，当损失90%的血量，回复效果会增加至54%",
        "type": "unique_passive"
      }],
      "suit": ""
    }
  ...
  "霸者重装": {
    ...
    "info": {
      ...
      "effect": [{
        "name": "复苏",
        "effect": "脱离战斗后，每秒回复2%最大生命值->每2秒回复1%最大生命值，脱离战斗后，回复速度提升至每2秒6%。",
        "type": "unique_passive"
      }],
      "suit": ""
    }
  ...
  "宗师之力": {
    ...
    "info": {
      ...
      "effect": [{
        ...
        "name": "强击",
        "effect": "增加效果——每次使用技能后增加8%移速，持续2秒。（不可叠加）",
        "type": "unique_passive"
      }],
      "suit": ""
    }
